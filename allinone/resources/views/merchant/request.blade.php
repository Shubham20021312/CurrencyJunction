  ...
  <div class="main-content">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                @if($item->status == null)                   
                    <button class="btn btn-success" onclick="approve('{{ $item->request_id }}')">Approval</button>
                    <button class="btn btn-danger" onclick="reject({{ $item->id }})">Reject</button>
                @else
                <button class="btn btn-success" disabled>Approval</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="approvalModalLabel">Bank Details</h5>
                ...
                <form id="approvalForm" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="bankName">Bank Name</label><span style="color:red;">*</span>
                        <input type="text" class="form-control" id="bankName" name="bankName" >
                    </div>
                    <div class="form-group">
                        <label for="accountHolderName">Account Holder Name</label><span style="color:red;">*</span>
                        <input type="text" class="form-control" id="accountHolderName" name="accountHolderName" >
                    </div>
                    <div class="form-group">
                        <label for="accountNumber">Bank Account Number</label><span style="color:red;">*</span>
                        <input type="text" class="form-control" id="accountNumber" name="accountNumber" >
                    </div>
                    <div class="form-group">
                        <label for="ifscCode">IFSC Code</label><span style="color:red;">*</span>
