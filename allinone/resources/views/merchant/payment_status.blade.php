...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{route('status')}}">PAYMENT STATUS </a>
        <!-- Form -->
    ...
    <div style="margin-bottom: 20px; background-color: #f9f9f9; border: 4px solid #ddd; border-radius: 5px; padding: 10px;">
        ...
        <div style="position: relative; height: 20px; margin-top: 10px; overflow: hidden;">
            ...
            @if($status->payment_process == 'Processing')
                yellow;
            @elseif($status->payment_process == 'completed')
                green;
            @elseif($status->payment_process == 'cancelled')
                red;
            @else
                #ccc;
            @endif
            ...
            @if($status->payment_process == 'completed')
                green;
            @else
                #ccc;
            @endif
            ...
            @if($status->payment_process == 'cancelled')
                red;
            @else
                #ccc;
            @endif
