...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{route('show_ticket')}}">Support Ticket</a>
        <!-- Form -->
    ...
    <div class="col-md-12">
        <div class="text-center mb-4">
            <h2 class="display-4">Browse Customer Support Tickets</h2>
            <p class="lead">Check out the latest inquiries and resolutions</p>
        </div>
        @isset($tickets)
            ...
            <table id="ticketsTable" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" onchange="changeStatus(this.value, {{ $ticket->id }})">
    ...
    function changeStatus(status, ticketId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // You can update UI or do something with the response if needed
            },
