...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{route('admin.user_payment_request')}}">User Transaction Request</a>
        <!-- Form -->
    ...
    <div class="container">
        <div class="table-responsive">
            <table id="userTable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    @foreach($user_request as $requests)
                    <tr>
                        <td>{{ $requests->id }}</td>
                        ...
                        <th>
                            <span class="badge <?php echo $badgeClass; ?>">
                                {{ $requests->after_proof }}
                            </span>
                        </th>
                        <td>
                            @if ($requests->proof)
                            <a href="{{ Storage::url($requests->proof)}}" target="_blank" class="btn btn-primary">View</a>
                            @else
                            No proof yet
                            @endif
                        </td>
                        <td>
                        <button type="button" class="btn btn-primary detailBtn" data-fee="{{ $requests->fee }}" data-amount="{{ $requests->amount }}"  data-rate="{{ $requests->rate }}"  data-transaction_type	="{{ $requests->transaction_type	 }}" data-toggle="modal" data-target="#detailModal">Detail</button>
                        </td>
                        <td>
                            @if ($requests->after_proof != 'Processing')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Transaction Type:</strong> <span id="transaction_type"></span></p>
            </div>
